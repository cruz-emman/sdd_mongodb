...
const Part3Number6 = () => {
    ...
    useEffect(() => {
        const getTables = async () => {
            try {
                const getTable16 = await publicRequest.get(`/results/resultChart?question_order=6&affiliate=${affiliation}&part=part3`)
                const sortData16 = getTable16.data.sort((a, b) => {
                    const choices = ['Yes', 'No', 'Not Applicable'];
                    ...
                    <Table sx={{ minWidth:650 }} size="small" aria-label="a dense table">
                        ...
                        {loading ? (
                            ...
                            />
                                ...
                                <>
                                    <TableCell>6) At home, there are occasions that we (spouse/partner) fight and hurt each other physically</TableCell>
