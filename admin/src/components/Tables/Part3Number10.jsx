...
const Part3Number10 = () => {
    ...
    useEffect(() => {
        const getTables = async () => {
            try {
                const getTable16 = await publicRequest.get(`/results/resultChart?question_order=10&affiliate=${affiliation}&part=part3`)
                const sortData16 = getTable16.data.sort((a, b) => {
                    const choices = ['Owned', 'Spouse/ Partner', 'Relatives, house helper etc', 'Not Applicable'];
